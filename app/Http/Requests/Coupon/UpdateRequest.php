...
class UpdateRequest extends FormRequest
{
    ...
    {
        return [
            'coupon_code'    => 'required|string|unique:coupons,coupon_code,' . $this->coupon,
    ...
    public function messages(): array
    {
        return [
            ...
            'coupon_status.in'       => 'The selected status is invalid. Allowed values: used, notused, cancelled.',
