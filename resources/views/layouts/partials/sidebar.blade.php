...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="">
            ...
            <li class=" nav-item"><a href="#"><i class="bx bx-lock-open-alt"></i><span class="menu-title" data-i18n="Coupon">Coupon Management</span></a>
                <ul class="menu-content">
            ...
            <li class=" nav-item"><a href="#"><i class="bx bx-building"></i><span class="menu-title" data-i18n="Payouts">{{ __('Payouts') }}</span></a>
                <ul class="menu-content">
                    <li><a href="{{ route('payouts') }}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="List">List</span></a>
                    </li>
                     <li><a href="{{ route('pending.payouts') }}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="List">Pending Payouts</span></a>
                    </li>
              ...
              <li class=" nav-item"><a href="#"><i class="bx bx-lock-open-alt"></i><span class="menu-title" data-i18n="Scan Logs">Scan Logs</span></a>
                <ul class="menu-content">
                    <li><a href="{{ route('scan-logs.index') }}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="List">List</span></a>
                    </li>
                </ul>
            </li>
