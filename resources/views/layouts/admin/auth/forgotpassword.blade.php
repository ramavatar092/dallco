                                ...
                                <div class="col-md-6 col-12 px-0">
                                    <div class="card disable-rounded-right mb-0 p-2">
                                        ...
                                        <div class="form-group d-flex justify-content-between align-items-center mb-2">
                                            <div class="text-left">
                                                <div class="ml-3 ml-md-2 mr-1"><a href="auth-login.html" class="card-link btn btn-outline-primary text-nowrap">Sign
                                                        in</a></div>
                                            </div>
                                            <div class="mr-3"><a href="auth-register.html" class="card-link btn btn-outline-primary text-nowrap">Sign
                                                    up</a></div>
                                        </div>
